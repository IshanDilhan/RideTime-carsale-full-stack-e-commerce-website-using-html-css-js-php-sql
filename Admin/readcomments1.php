...
$query  = "SELECT `com_name`, `_comsubject`, `email`, `massage`, `comment_id`, `comment_available`
FROM `comments`
            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    <div class="cta-content">
                        <br>
                        <br>
                        <h2>Read your <em>Comments</em></h2>
                        <p>READ what they are saying</p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="container table-responsive">
  <table class="table table-bordered table-striped">
    ...
    <div class="message-content " ><?php echo $row['massage']; ?></div>
          ...
          <?php
if ( $row['comment_available']== 1) {
?>
    <td style="text-align: center; vertical-align: middle;">
    <img style="height: 25px; width: 25px; cursor: pointer;" src="./../assets/images/correct.png" alt="enable" onclick="enableDesable(<?php echo $row['comment_id']; ?>, 'd')">
</td>
...
?>
    <td style="text-align: center; vertical-align: middle;">
        <img style="height: 25px; width: 25px; cursor: pointer;" src="./../assets/images/wrong.png" alt="disable" onclick="enableDesable(<?php echo $row['comment_id']; ?>, 'e')">
    </td>
<?php
}
?>
